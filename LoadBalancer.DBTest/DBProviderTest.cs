...
namespace LoadBalancer.DBTest
{
    ...
    class DBProviderTest
    {
        ...
        public void DBProviderKonstruktorDobarTest()
        {
            ...
            Assert.AreEqual(db.Log.TxtFileName, @"C:\Users\David Petrovic\Desktop\LoadBalancer Project\Load Balancer\Projekat LoadBalancer\LoadBalancer\DB\writerLogServer.txt");
        }             
    }
}
